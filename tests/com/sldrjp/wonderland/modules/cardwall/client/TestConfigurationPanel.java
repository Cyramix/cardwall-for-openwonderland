 ...
 */
public class TestConfigurationPanel extends JFrame {

    CardWallCellClientState state;
        public static void main(String[] args) {
        TestConfigurationPanel testConfigurationPanel = new TestConfigurationPanel();
    }

    public TestConfigurationPanel() {
        state = CardWallDefaultConfiguration.getDefaultState();
        CardWallConfiguration conf = new CardWallConfiguration(this, true);
        conf.setCardWallState(state);
